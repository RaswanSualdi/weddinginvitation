...
<div class="card">
    ...
    <div class="card-body">
      <div class="button" style="margin-bottom: 0px;">
        <a href="{{route('admin.blueocean.add')}}" class="btn btn-primary">Tambah Data</a>
      </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <div class="col">
                <a style="text-decoration: none; color: black;" href="{{route('show.blueocean', $item->slug)}}"><ion-icon name="link-outline"></ion-icon></a>
